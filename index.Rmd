...
previousdata <- merge(trendmorecommodities[, .(date, Trend = normalised)], backtestPnL[,.(date, `GSCI backtest` = normalised)], by = "date", all.y = TRUE)

previousdata <- merge(previousdata, trend_GSCI_commodities[, .(date, `Trend GSCI commodities` = normalised)], by = "date", all.x = TRUE)

previousdata <- merge(previousdata, backwardationPnL[, .(date, Backwardation = normalised)], by = "date", all.y = TRUE)
